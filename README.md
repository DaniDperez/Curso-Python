# Programas y Retos del Curso de Python  
**Autor:** Ernesto Daniel Piña Pérez  
**Año:** 2025  
...
- **Operadores aritméticos y lógicos**, y el uso de condicionales `if`, `elif`, `else`.  
- **Bucles `for` y `while`**, aplicados a tareas de registro y control de procesos.  
- **Listas, tuplas y diccionarios** para almacenar, organizar y manipular información.  
- **Funciones** para modularizar el código y hacerlo más ordenado.  
- **Clases y objetos (POO)** para representar componentes o entidades con atributos y comportamientos.  
...
- Aplicación de principios básicos de programación modular y orientada a objetos.  
...
Egresado de Ingeniería en Sistemas Automotrices – UPIITA-IPN  
Interesado en programación, electrónica y desarrollo de sistemas embebidos.  
